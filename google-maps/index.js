...
function onChatBotReady() {
  ...
  var apiKey = ModwebsWebview('getParameter', 'googlemapsKey');
...
function sendResponse() {
  ...
  */
  ModwebsWebview('sendResponse', '', outputs, 'Chose Location').catch((err) => {
    console.log(err);
  });
}
