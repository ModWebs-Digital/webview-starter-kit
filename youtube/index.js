...
function sendResponse() {
  ...
  */
  ModwebsWebview('sendResponse', state, { currentSeconds }, 'Button Clicked').catch((err) => {
    console.log(err);
  });
}
